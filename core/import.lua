...
function XelosesContacts:ImportESOFriends(target_group)
    self:ImportESOList(self.CONST.CONTACTS_FRIENDS_ID, target_group)
end

function XelosesContacts:ImportESOIgnored(target_group)
...
function XelosesContacts:ImportESOList(category, target_group)
