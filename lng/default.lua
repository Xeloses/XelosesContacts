...
L("SETTINGS_CHAT_BLOCK_CHANNELS_DESCRIPTION", "Setup chat channels for blocking messages from Villains (addon will block/hide messages only from Villains in groups with \"Block chat\" option set to [ON]).")
