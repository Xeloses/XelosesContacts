...
L("CONFIRM_IMPORT_VILLAINS", "Are you sure want to import all ESO ingame ignored players to Contacts?")
...
L("SETTINGS_RETICLE_MARKER_DISABLE_COMBAT_TOOLTIP", "Disable reticle targets detecting in combat (may improve performance).")
...
L("SETTINGS_RETICLE_MARKER_DISABLE_TRIAL_TOOLTIP", "Disable reticle targets detecting in trials (may improve performance in trials).")
L("SETTINGS_RETICLE_MARKER_DISABLE_PVP", "Disable in PvP-zones")
L("SETTINGS_RETICLE_MARKER_DISABLE_PVP_TOOLTIP", "Disable reticle targets detecting in PvP-zones: Cyrodiil, Imperial city, battlegrounds (may improve performance in those zones).")
...
L("SETTINGS_RETICLE_MARKER_ADDITIONAL_MARKERS_DESCRIPTION", "Additional markers may have slightly performance impact in places with many players aroud (e.g. cities).")
...
L("SETTINGS_CHAT_BLOCK_GROUP", "Block chat for <<1>>")
