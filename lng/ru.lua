...
L("CONFIRM_IMPORT_VILLAINS", "Вы уверены что хотите импортировать всех игнорируемых игроков в Контакты?")
...
L("UI_CONTACTS_COUNT", "Всего контактов: %d друзей и %d недругов.")
...
L("SETTINGS_COLOR", "<<1>>")
L("SETTINGS_GROUPS", "Группы контактов")
L("SETTINGS_GROUPS_DESCRIPTION", "Изменить группы контактов.")
L("SETTINGS_GROUPS_NOTE", "Примечания:\n  - при удалении группы все контакты из нее будут автоматически перемещены в группу <<1>>;\n  - нельзя удалить базовые группы;\n  - изменения групп могут не вступить в силу до перезагрузки интерфейса.")
L("SETTINGS_GROUPS_SELECT", "Группа для редактирования:")
L("SETTINGS_GROUPS_BUTTON_ADD", "Создать")
L("SETTINGS_GROUPS_BUTTON_ADD_TOOLTIP", "Создать новую группу.")
L("SETTINGS_GROUPS_BUTTON_REMOVE", "Удалить")
L("SETTINGS_GROUPS_BUTTON_REMOVE_TOOLTIP", "Удалить выбранную группу.")
L("SETTINGS_GROUPS_BUTTON_REMOVE_WARNING", "Выбранная группа будет безвозвратно удалена. Это действие нельзя отменить!")
...
L("SETTINGS_CHAT_BLOCK_GROUPS_DESCRIPTION", "Блокировка чата по группам.\nПримечание: блокировка чата доступна только для базовых групп Недругов.")
L("SETTINGS_CHAT_BLOCK_GROUP", "Блокировать чат для группы <<1>>")
